...
export interface ReferClientContext {
    refer(options: { extraHeaders: string[], receiveResponse: () => void }): ReferClientContext;
}

export interface ReferServerContext {
    progress(): void;
    reject(options: { statusCode: number = 480 }): void;
    accept(options: { extraHeaders: string[], followRefer: boolean = true }): void;
